    ...
    <form className="RegisterUser">
        <div className="RegisterUserDiv">
                  ...
                  <tr>
                    <td>User ID</td>
                    <td>
                    <input placeholder='Enter User Name' value={userID} onChange={(e) => setUserID(e.target.value)} type="text"/> 
                    </td>
                  </tr>
                  <tr>
                  <td>
                  ...
                  <tr>
                    <td colSpan={2}>
                    <input type="button" value="Register User" onClick={ e => clickRegisterUser(e)} ></input>
                    </td>
